      ...
      <div className="flex justify-around max-sm:flex-wrap max-sm:gap-x-11">
        <div className="max-sm:mb-10">
          ...
          <ul className="flex flex-col gap-2 mt-4">
            ...
            <li className="flex items-center gap-2 text-sm max-sm:text-xs">
              <svg fill="#ffffff" width="25px" height="25px" viewBox="0 -4 32 32" xmlns="http://www.w3.org/2000/svg">
                <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                <g id="SVGRepo_iconCarrier">
        ...
        <div className="max-sm:mb-10">
          <h3 className="text-2xl font-bold max-sm:text-xl">Front-end</h3>
          <ul className="flex flex-col gap-2 mt-4">
            <li className="flex items-center gap-2 text-sm max-sm:text-xs">
              <svg
                fill="#ffffff"
            ...
            <li className="flex items-center gap-2 text-sm max-sm:text-xs">
              <svg width="25px" height="25px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#ffffff">
                <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                <g id="SVGRepo_iconCarrier">
            ...
            <li className="flex items-center gap-2 text-sm max-sm:text-xs">
              <svg fill="#ffffff" width="25px" height="25px" viewBox="0 -0.5 25 25" xmlns="http://www.w3.org/2000/svg">
                <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                <g id="SVGRepo_iconCarrier">
        ...
        <div className="max-sm:mb-10">
          <h3 className="text-2xl font-bold max-sm:text-xl">Back-end</h3>
          <ul className="flex flex-col gap-2 mt-4">
            <li className="flex items-center gap-2 text-sm max-sm:text-xs">
              <svg
                fill="#ffffff"
        ...
        <div>
          <h3 className="text-2xl font-bold max-sm:text-xl">Autres</h3>
          <ul className="flex flex-col gap-2 mt-4">
            <li className="flex items-center gap-2 text-sm max-sm:text-xs">
              <svg
                width="25px"
