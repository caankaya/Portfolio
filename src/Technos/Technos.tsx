export default function Technos() {
  return (
    <div className="w-full" id="technos">
      ...
      <div className="flex justify-between max-sm:justify-around max-sm:flex-wrap max-sm:gap-x-16">
        <div className="max-sm:mb-10">
          <h3 className="text-sm font-bold bg-secondary rounded-md text-center py-1 text-white">
            Design
          </h3>
        ...
        <div className="max-sm:mb-10">
          <h3 className="text-sm text-white font-bold bg-secondary rounded-md text-center py-1">
            Front-end
          </h3>
          <ul className="flex flex-col gap-2 mt-4">
            <li className="flex items-center gap-2 text-sm max-sm:text-xs">
        ...
        <div>
          <h3 className="text-sm text-white font-bold bg-secondary rounded-md text-center py-1 px-[35px]">
            Autres
          </h3>
          <ul className="flex flex-col gap-2 mt-4">
            <li className="flex items-center gap-2 text-sm max-sm:text-xs">
