    ...
    <div className="w-full" id="projects">
      ...
      <div className="flex justify-between max-sm:flex-col max-sm:gap-y-2">
        <motion.div
          ...
          className="card w-[30%] bg-base-100 shadow-xl max-sm:w-full"
        >
          <Link
            to={"https://github.com/Canoral/carte-interactive-geneve"}
            target="_blank"
          >
            ...
            <div className="card-body">
              ...
              <p className="text-sm max-sm:text-xs">
                Une application interactive de cartographie qui présente les
                faits et les personnages historiques liés au passé de Genève.
              </p>
