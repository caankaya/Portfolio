    ...
    <div className="w-full">
      ...
      <div className="flex justify-between">
        <div className="card w-[30%] bg-base-100 shadow-xl">
          <figure>
            <img src="ville.png" alt="ville de Genève" />
          </figure>
          <div className="card-body">
            ...
            <div className="card-actions justify-end">
              ...
              <div className="badge badge-secondary">
                <svg width="15px" height="15px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="#ffffff">
                  <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                  <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                  <g id="SVGRepo_iconCarrier">
            ...
            <Link to={"#"}>Lien vers le repos Github</Link>
          </div>
        </div>
        <div className="card w-[30%] bg-base-100 shadow-xl">
          <figure>
            <img src="reims.png" alt="Université de Reims" width={310} />
          </figure>
          <div className="card-body">
        ...
        <div className="card w-[30%] bg-base-100 shadow-xl">
          <figure>
            <img src="oworld.png" alt="logo de l'application O'World" width={180} />
          </figure>
          <div className="card-body">
            ...
            <div className="card-actions justify-end">
              ...
              <div className="badge badge-secondary">
                <img src="d3.png" alt="logo de d3js" width={15} />
                <span className="ml-1 text-white">D3js</span>
              </div>
            </div>
          </div>
        </div>
